...
?>
<!DOCTYPE html>
<!-- saved from url=(0043)https://newsnatorbloggertheme.blogspot.com/ -->
...
<link href="./Newsnator_files/3416767676-css_bundle_v2.css" rel="stylesheet" type="text/css">
<!-- Blog page title -->
<title>
Step By Step Visas | Blog
</title>
...
<!--*********** Facebook Graph ************-->
<meta content="Newsnator" property="og:site_name">
...
<link href="https://b/img/fav.png" rel="icon" type="image/x-icon">
<link href="http://newsnatorbloggertheme.blogspot.com/" rel="canonical">
...
<![endif]-->
<meta content="http://newsnatorbloggertheme.blogspot.com/" property="og:url">
<meta content="Newsnator" property="og:title">
...
<Variable name="link.color" description="Link Color" type="color" default="#05034d"/>
...
.section{margin:0;}
a:link,a:visited{color:#05034d;text-decoration:none;}
...
.news .recent-title a{color:#05034d;overflow:hidden;height:50px;float:left;text-overflow:ellipsis;white-space:nowrap;width:100%;}
/*=====================================
= Search Box
=====================================*/
...
= Navigation Bar
=====================================*/
body.sticky-header .menu li ul li a:hover{background-color:#05034d;}
body.sticky-header .transparent-navigation{background-color:#05034d;}
body.sticky-header li.home-child a i,body.sticky-header .menu li ul li a{color:#05034d;}
...
.post h3{font-size:35px;margin-bottom:10px;margin-top:10px;color:#05034d;}
.post h4{color:#05034d;font-weight:900;font-size:30px;margin-top:10px;margin-bottom:10px;}
...
.about_admin-bg{background-image:url(https://2.bp.blogspot.com/-WM4siHOJbUE/WOULKBO-fhI/AAAAAAAAB5Y/bldAzGfNXJgeIBQsiwClbfwfc24cqQBOgCLcB/s1600/sub-bg.jpg);background-attachment:fixed;background-size:cover;padding:65px 0;margin-left:80px;}
...
body#layout .admin-panel:after{content:' Admin Panel';margin-left:5px;}
body#layout #layout-logo{background:url(https://3.bp.blogspot.com/-HKc2vekkiH8/V3Dw-2ANLWI/AAAAAAAAJSg/qLyZ5f-B21Ycxv4w_H9ZERC9tuANYmLnACLcB/s320/-3rdlogo.png) no-repeat;height:94px!important;width:132px;float:right!important;display:block;overflow:hidden;margin-right:50px;margin-top:-90px;}
</style>
<script src="./Newsnator_files/jquery.min.js.download" type="text/javascript"></script>
<script src="./Newsnator_files/jquery.min.js.download" type="text/javascript"></script>

<link href="assets/css/home.min.css" rel="stylesheet"/>
<link href="./Newsnator_files/authorization.css" media="all" onload="if(media!=&#39;all&#39;)media=&#39;all&#39;" rel="stylesheet">
...
<?php
  if($pageno == 1) {
	$sql = "SELECT * FROM blogs where id = '97'";
...
<meta itemtype="https://schema.org/WebPage" itemid="blog.html" itemprop="mainEntityOfPage" itemscope="">
<div itemprop="image" itemscope="itemscope" itemtype="https://schema.org/ImageObject">
<img src="../assets/web/img/blogs/<?= $row['pic']; ?>" style="display:none;">
...
image_tag='<div class="post-anime"><img src="'+image_url.replace('../assets/web/img/blogs/<?= $row['pic']; ?>','/s'+image_size)+'" class="postthumb1" alt="'+post_title+'" width="'+width_size+'" height="'+height_size+'"/></div>';
...
<div class="post-anime">
	<img src="../assets/web/img/blogs/<?= $row['pic']; ?>" class="postthumb1" alt="<?= $row['title']; ?>" width="130" height="195"></div></div>
<a name="4867340620984877934"></a>
<div class="xoai6-overlay">
<div class="overlay-child-a">
<h2 class="post-title entry-title" itemprop="headline">
<a href="blog.php?b_code=<?= $row['id']; ?>"><?= $row['title']; ?></a>
</h2>
<span id="4867340620984877934" itemprop="description"><div class="contento"><?= substr(strip_tags($row['text']),0,100) . '...'; ?></div></span>
<script type="text/javascript">summary("4867340620984877934")</script>
</div>
<div class="overlay-child-b">
<div class="readmore">
<a href="blog.php?b_code=<?= $row['id']; ?>">Read More<i class="fa fa-angle-double-right"></i></a>
</div>
</div>
</div>
...
<a href="http:// Step Visas</a></span></span>
</div>
...
<?php
	...
	$sql = "SELECT * FROM blogs where id != '97' ORDER BY id DESC LIMIT $offset, $no_of_records_per_page";
	$result = $conn->query($sql);
...
<div class="blog-pager" id="blog-pager">
	<ul style="display: inline-flex;list-style: none;">
        <li>
					...
					<a class="blog-pager-older-link" href="?pageno=1" >First</a>
					</span>
				</li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
					<span id="blog-pager-older-link">
					<a class="blog-pager-older-link" href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>" >Prev <i class="fa fa-arrow-left"></i></a>
					</span>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
					<span id="blog-pager-older-link">
					<a class="blog-pager-older-link" href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>" >Next <i class="fa fa-arrow-right"></i></a>
					</span>
        </li>
        <li>
					<span id="blog-pager-older-link">
					<a class="blog-pager-older-link" href="?pageno=<?php echo $total_pages; ?>" >Last</a>
					</span>
				</li>
    </ul>
...
Subscribe to:
<a class="feed-link" href="https://newsnatorbloggertheme.blogspot.com/feeds/posts/default" target="_blank" type="application/atom+xml">Posts (Atom)</a>
</div>
</div>
</div></div>
</div>
...
<img alt="" border="0" src="./Newsnator_files/7-4(2).jpg">
</a>
</div>
<div class="item-title"><a href="blog.html">Immigration To Canada . The Process!</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
<li>
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/the-nature-artifact-with-amazon-fashion.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/16(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/the-nature-artifact-with-amazon-fashion.html">The Nature Artifact with Amazon Fashion Week 2020 in World Expo</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/an-island-in-eastern-river-worth-one.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/7-1(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/an-island-in-eastern-river-worth-one.html"></a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/green-sea-penguins-seeing-rare-national.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/7-2(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/green-sea-penguins-seeing-rare-national.html">Green Sea Penguins Seeing Rare | National Animal Report</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/grow-with-google-scholars-new.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/s3(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/grow-with-google-scholars-new.html">Grow with Google Scholars: A New Initiative is Rising</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/it-ministry-board-decided-to-take-govt.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/s5.jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/it-ministry-board-decided-to-take-govt.html">IT Ministry Board Decided to Take Govt Taxes on Server Rooms</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/water-pressure-and-shelling-on.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/15(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/water-pressure-and-shelling-on.html">Water Pressure and Shelling on Columbian Protestors</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/high-resolution-mobile-cameras-giving.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/s4(2).jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/high-resolution-mobile-cameras-giving.html">High Resolution Mobile Cameras Giving Tough Time to DSLR'S</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/business-week-economy-of-european-union.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/2.jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/business-week-economy-of-european-union.html">Business Week: Economy of the European Union</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<div class="item-content">
<div class="item-thumbnail">
<a href="https://newsnatorbloggertheme.blogspot.com/2018/08/manual-vs-automatic-war-between-two.html" target="_blank">
<img alt="" border="0" src="./Newsnator_files/9.jpg">
</a>
</div>
<div class="item-title"><a href="https://newsnatorbloggertheme.blogspot.com/2018/08/manual-vs-automatic-war-between-two.html">Manual Vs Automatic: A War between two Mode of Cars</a></div>
<div class="item-snippet">  Today news about the falling economy of the European&nbsp;Union&nbsp;is going to be a headache for wall street wolfs who want to tick tack their inv...</div>
</div>
<div style="clear: both;"></div>
</li>
...
<a class="quickedit" href="https://www.blogger.com/rearrange?blogID=8301813360242143088&amp;widgetType=PopularPosts&amp;widgetId=PopularPosts1&amp;action=editWidget&amp;sectionId=sidebar" onclick="return _WidgetManager._PopupConfig(document.getElementById(&quot;PopularPosts1&quot;));" rel="nofollow" target="configPopularPosts1" title="Edit">
<img alt="" height="18" src="./Newsnator_files/icon18_wrench_allbkg.png" width="18">
</a>
</span>
</span>
<div class="clear"></div>
...
<ul>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/business">business</a>
<span dir="ltr">(2)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/health">health</a>
<span dir="ltr">(1)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/news">news</a>
<span dir="ltr">(18)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/politics">politics</a>
<span dir="ltr">(3)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/science">science</a>
<span dir="ltr">(1)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/sport">sport</a>
<span dir="ltr">(1)</span>
</li>
<li>
<a dir="ltr" href="https://newsnatorbloggertheme.blogspot.com/search/label/tech">tech</a>
<span dir="ltr">(4)</span>
</li>
</ul>
<div class="clear"></div>
...
<li>
<div class="footersec section" id="footersec2" name="Featured Post"><div class="widget FeaturedPost" data-version="1" id="FeaturedPost1">
<h2 class="title">Featured Post</h2>
<div class="post-summary">
<h3><a href="blog.php?b_code=21">Ontario invited 699 candidates in the Human Capital Priorities Stream</a></h3>
<p>
  On June 3, 2020, the Ontario Immigrant Nominee Program (OINP) held two draws in the Ontario’s ...
</p>
<img class="image" src="../assets/web/img/blogs/9e2a72140e81d539e8bf9a829880b141.jpg">
</div>
<style type="text/css">
    .image {
      width: 100%;
...
<span class="widget-item-control">
<span class="item-control blog-admin">
<a class="quickedit" href="https://www.blogger.com/rearrange?blogID=8301813360242143088&amp;widgetType=FeaturedPost&amp;widgetId=FeaturedPost1&amp;action=editWidget&amp;sectionId=footersec2" onclick="return _WidgetManager._PopupConfig(document.getElementById(&quot;FeaturedPost1&quot;));" rel="nofollow" target="configFeaturedPost1" title="Edit">
<img alt="" height="18" src="./Newsnator_files/icon18_wrench_allbkg.png" width="18">
</a>
</span>
</span>
...
<div class="footer-widget-box footer-widget-box-middle">
<ul class="widget-container">
<li>
<div class="footersec section" id="footersec3" name="Recent Posts"><div class="widget PopularPosts" data-version="1" id="PopularPosts2">
<h2>Popular Posts</h2>
<div class="widget-content popular-posts">
<ul>
	<?php
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) { ?>
    		<li>
					<div class="item-content">
					<div class="item-thumbnail">
					<a href="blog.php?b_code=<?= $row['id']; ?>" target="_blank">
					<img alt="" border="0" src="../assets/web/img/blogs/<?= $row['pic']; ?>">
					</a>
					</div>
					<div class="item-title"><a href="blog.php?b_code=<?= $row['id']; ?>"><?= $row['title']; ?></a></div>
					<div class="item-snippet"><?= substr(strip_tags($row['text']),0,50) . '...'; ?></div>
					</div>
					<div style="clear: both;"></div>
				</li>
      <?php }
...
<span class="widget-item-control">
<span class="item-control blog-admin">
<a class="quickedit" href="https://www.blogger.com/rearrange?blogID=8301813360242143088&amp;widgetType=PopularPosts&amp;widgetId=PopularPosts2&amp;action=editWidget&amp;sectionId=footersec3" onclick="return _WidgetManager._PopupConfig(document.getElementById(&quot;PopularPosts2&quot;));" rel="nofollow" target="configPopularPosts2" title="Edit">
<img alt="" height="18" src="./Newsnator_files/icon18_wrench_allbkg.png" width="18">
</a>
</span>
</span>
...
<ul class="widget-container">
<li>
<div class="footersec section" id="footersec1" name="Subscribe"><div class="widget FollowByEmail" data-version="1" id="FollowByEmail2">
<h2 class="title">Follow By Email</h2>
<div class="widget-content">
<div class="follow-by-email-inner">
  <form action="includes/add_sub.php" method="post" >
...
<span class="widget-item-control">
<span class="item-control blog-admin">
<a class="quickedit" href="https://www.blogger.com/rearrange?blogID=8301813360242143088&amp;widgetType=FollowByEmail&amp;widgetId=FollowByEmail2&amp;action=editWidget&amp;sectionId=footersec1" onclick="return _WidgetManager._PopupConfig(document.getElementById(&quot;FollowByEmail2&quot;));" rel="nofollow" target="configFollowByEmail2" title="Edit">
<img alt="" height="18" src="./Newsnator_files/icon18_wrench_allbkg.png" width="18">
</a>
</span>
</span>
