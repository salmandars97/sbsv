			...
			<div class="col-md-12 col-sm-12 col-xs-12 booking-right" style="background-color:#05034d;">
				<h4 class="text-white" style=" text-align: center; font-family: 'Helvetica Neue' ,Helvetica,Arial,sans-serif; font-size: 20px; font-weight: 600;" >FREE Assessment!</h4>
				<form action="<?= base_url().'Leads/added_leads ' ?>" method="POST" enctype="multipart/form-data" onsubmit="return submitUserForm();">
					...
					<button class="bg-light btn btn-default btn-lg btn-block text-center submit" ><span class="text-primary">Request a Free Assessment</span></button>
					<div class="msg"></div>
