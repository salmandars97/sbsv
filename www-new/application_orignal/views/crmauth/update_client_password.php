	...
	<div class="right_col" role="main">
		<div class="">
			<div class="page-title">
				...
				<a href="<?php echo base_url().'Crmauth/display_clients' ?>"><input type="submit" class="btn btn-info btn-md" style="float:right;" value="Back"></a>
				</div>
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="form-horizontal form-label-left" >
								<?php $attributes = array('id' => 'Crmauth/update_client_password','name' => 'Crmauth/update_client_password' ); ?>
				 
								<?php echo form_open_multipart(''.base_url().'Crmauth/updated_client_password',$attributes);?>
