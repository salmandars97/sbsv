              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url().'About/updated_about' ?>" enctype="multipart/form-data" >


                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pic">Picture <span class="required">*</span></label>
                        <img id="currentImg" class="img-responsive" src="<?php echo base_url().'/assets/web/img/pages/'.$value->pic.' ' ?>" style="max-width:450px;  max-height:400px;"> 
