			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<div class="col-md-6">
								<h2>Australia Leads<small></small></h2>
							</div>
						...
						<table id="datatable" class="table table-bordered table-striped" width="100%">
							<thead>
								<tr>
									...
									<th>Partner Skills and Qualification</th>
									<th>Reference</th>
									<th>File</th>
									<th>Action</th>
								</tr>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form action="<?php echo base_url().'Leads/delete_auassessment' ?>" method="post">
										...
										<a href="<?php echo base_url().'Leads/assign_assessment?aid=' . $value->id . '&atype=ima&page=' . $page; ?>" class="btn btn-primary btn-sm">
											Assign
										</a>
									</td>
									<?php } ?>
