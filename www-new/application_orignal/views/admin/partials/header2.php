        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
					<li><a href="<?php echo base_url().'Leads/inv_leads2' ?>"><i class="fa fa-home"></i>Home</a></li>				
 </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="<?= base_url() ?>Insauth/logout"">
				...
				<nav>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="">
							...
							<li><a href="<?= base_url() ?>Insauth/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
							</ul>
						</li>
