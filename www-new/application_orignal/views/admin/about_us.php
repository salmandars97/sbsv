          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <td><?= $value->id ?></td>
                <td><?= $value->text ?></td>
                <td><img style="max-width:200px;max-height:150px;" src="<?php echo base_url().'./assets/web/img/pages/'.$value->pic.'' ?>" ></td>
                <td><form action="<?php echo base_url().'About/update_about' ?>" method="get">
