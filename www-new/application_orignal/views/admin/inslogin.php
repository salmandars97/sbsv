      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form id="frm_login" role="form" action="<?php echo base_url() ?>Insauth/login" method="POST">
              <h1>Login Form</h1>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-hashtag"></i>Investment Leads Panel</h1>
            ...
            $("#frm_login").submit(function (e){
                ...
                $.ajax({
                   ...
                   if(data !=='')
                    ...
                    window.location.href='<?php echo base_url() ?>Leads/inv_leads2';
