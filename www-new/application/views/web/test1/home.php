...
<main class="wrapper">
			...
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="wptb-slider--item">
						<div class="wptb-slider--image" style="background-image: url('assets/img/slider/6.jpg');"></div>
						<div class="container">
							<div class="row">
								<!-- Content Column -->
								<div class="col-lg-12">
				...
				<div class="swiper-slide">
					<div class="wptb-slider--item">
						<div class="wptb-slider--image" style="background-image: url('assets/img/slider/7.jpg');"></div>
						<div class="container">
							<div class="row">
								<!-- Content Column -->
				...
				<div class="swiper-slide">
					<div class="wptb-slider--item">
						<div class="wptb-slider--image" style="background-image: url('assets/img/slider/8.jpg');"></div>
						<div class="container">
							<div class="row">
								<!-- Content Column -->
								<div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
									<div class="wptb-heading">
										<div class="wptb-item--inner">
											<h6 class="wptb-item--subtitle"> WELCOME TO DirectoryBaba.com VISA AGENCY </h6>
											<h1 class="wptb-item--title"> We Help You to Explore the worlds with <span class="active">DirectoryBaba.com</span></h1>
											<p class="wptb-item--description">We provide a complete immigration & visa services for America,
												Canada & Australia for travel & education</p>
											<div class="wptb-item--button"> <a class="btn-readmore style-default" href="services-1.html"> <span class="btn-readmore--text"> Get Started </span> </a></div>
										</div>
						...
						<div class="wptb-heading">
							<div class="wptb-item--inner">
								...
								<p class="wptb-item--description">
									DirectoryBaba.com Visa Consultancy was created to provide uniquely designed premium services in the world of education and migration.As people are dreaming more hands-on experience.
								</p>
							</div>
						</div>
					...
					<div class="wptb-image-single wow skewIn">
						<div class="wptb-item--inner">
							<div class="wptb-item--image">
								<img src="assets/img/3.png" alt="img" class="image-main">
						...
						<div class="wptb-image-box1 wow fadeInLeft">
							<div class="wptb-item--inner">
								...
								<div class="wptb-item--holder">
									...
									<p class="wptb-item--description"> DirectoryBaba.com Visa Consultancy takes great
						...
						<div class="wptb-image-box1 wow fadeInLeft">
							<div class="wptb-item--inner">
								...
								<div class="wptb-item--holder">
									...
									<h4 class="wptb-item--title"><a href="service-details.html">Green Card Application</a></h4>
									<div class="wptb-line-paper"></div>
			...
			<div class="row">
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/korea.jpg" alt=""></div>
								<div class="wptb-item--holder">
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/uk.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/finland.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/australia.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/japan.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/germany.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/canada.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					<div class="wptb-country-grid">
						<div class="wptb-icon-box1 wow fadeInLeft">
							<div class="wptb-item--inner flex-start">
								<div class="wptb-item--icon"><img src="assets/img/country/france.jpg" alt=""></div>
								<div class="wptb-item--holder">
									<p class="wptb-item--description">Visa Services</p>
	...
	<!-- Why Choose -->
	<section class="wptb-why-choose-three bg-image" style="background-image: url('assets/img/background/bg-14.jpg');">
		<div class="container">
			<div class="wptb-heading">
				<div class="wptb-item--inner text-center">
					<h6 class="wptb-item--subtitle">
			...
			<div class="wptb-why-choose--inner">
				<div class="row g-0">
					...
					<!-- Iconbox -->
					<div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-end ps-md-0 pb-md-0 wow fadeInLeft">
						<div class="wptb-item--inner">
							<div class="wptb-item--holder">
								<div class="wptb-item--icon">
					...
					<!-- Iconbox -->
					<div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 border-1 border-end pb-md-0 wow fadeInLeft">
						<div class="wptb-item--inner">
							<div class="wptb-item--holder">
								<div class="wptb-item--icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="38" height="42" viewBox="0 0 38 42" fill="none">
					...
					<!-- Iconbox -->
					<div class="col-sm-6 col-md-4 wptb-icon-box2 mb-0 p-5 pe-md-0 pb-md-0 wow fadeInLeft">
						<div class="wptb-item--inner">
							<div class="wptb-item--holder">
								<div class="wptb-item--icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
	...
	<div class="wptb-video-player1 wow zoomIn">
		<div class="wptb-item--inner">
			<div class="wptb-item--holder">
				<div class="wptb-item--image">
					<img src="assets/img/background/bg-5.jpg" alt="img">
				</div>
				<div class="wptb-item--button">
					...
					<div class="col-md-6">
						<div class="wptb-accordion wptb-accordion1 wow fadeInUp">
							<div class="wptb--item active">
								<h6 class="wptb-item-title"><span>Q1. Which is the prerequisites for immigration?</span> <i class="bi bi-chevron-down"></i></h6>
							...
							<div class="wptb--item">
								<h6 class="wptb-item-title"><span>Q2. What are the contact address of DirectoryBaba.com?</span> <i class="bi bi-chevron-down"></i></h6>
								<div class="wptb-item--content">
									Our business consulting programs helps to break the performance of your business down into customers and product groups so you know exactly which customers or product groups are working.
								</div>
							</div>
							...
							<div class="wptb--item">
								<h6 class="wptb-item-title"><span>Q3. What IELTS Score required for Canada?</span> <i class="bi bi-chevron-down"></i></h6>
								<div class="wptb-item--content">
									Our business consulting programs helps to break the performance of your business down into customers and product groups so you know exactly which customers or product groups are working.
								</div>
							</div>
							...
							<div class="wptb--item">
								<h6 class="wptb-item-title"><span>Q4. How much time needed for visa renewal?</span> <i class="bi bi-chevron-down"></i></h6>
								<div class="wptb-item--content">
									Our business consulting programs helps to break the performance of your business down into customers and product groups so you know exactly which customers or product groups are working.
								</div>
							</div>
							...
							<div class="wptb-item--button">
								<a class="btn--readmore" href="faq.html">
	...
	<section class="wptb-pricing-package-one">
		<div class="container">
			...
			<div class="wptb-packages1 style-gradient active highlight wow fadeInLeft">
				<div class="wptb-item--inner">
			...
			<div class="wptb-packages1 style-gradient wow fadeInLeft">
				<div class="wptb-item--inner">
					<div class="wptb-item--left-part">
						<div class="wptb-item--holder">
	...
	<section class="wptb-faq-two p-0">
		<div class="wptb-image-single position-absolute start-0 top-0 bottom-0 d-none d-lg-block wow skewIn">
			<div class="wptb-item--inner h-100">
				<div class="wptb-item--image h-100">
					<img src="assets/img/2.jpg" alt="img" class="h-100">
				</div>
			</div>
		</div>
		...
		<div class="container">
					...
					<div class="wptb-faq--inner pb-5">
						<div class="wptb-heading">
							<div class="wptb-item--inner">
								...
								<h1 class="wptb-item--title"> <span>We have Association with <br>
									prestigious Entities</span></h1>
							</div>
						</div>
					</div>
				</div>
			...
			<!-- Tabs -->
			<div class="wptb-tab style-gradient">
				<div class="wptb-item--inner">
					<div class="wptb-item--left">
						<div class="tab-content">
							<div class="tab-pane fade show active" id="tab-one" role="tabpanel">
								<div class="wptb-tab-content">
									<div class="wptb-tab-content--holder">
										<div class="wptb-tab-content--icon">
											<img src="assets/img/clients/hc-logo1.png" alt="icon">
										</div>
										<h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
										<p class="wptb-tab-content--description"> DirectoryBaba.com Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
										<div class="wptb-item--button"> 
											<a class="btn--readmore" href="contact-1.html"> 
												<span class="btn-readmore--text"> Get Service </span> 
											</a>
										</div>
									</div>
								</div>
							...
							<div class="tab-pane fade" id="tab-two" role="tabpanel">
								<div class="wptb-tab-content">
									<div class="wptb-tab-content--holder">
										<div class="wptb-tab-content--icon">
											<img src="assets/img/clients/hc-logo2.png" alt="icon">
										</div>
										<h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
										<p class="wptb-tab-content--description"> DirectoryBaba.com Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
										<div class="wptb-item--button"> 
							...
							<div class="tab-pane fade" id="tab-three" role="tabpanel">
								<div class="wptb-tab-content">
									<div class="wptb-tab-content--holder">
										<div class="wptb-tab-content--icon">
											<img src="assets/img/clients/hc-logo3.png" alt="icon">
										</div>
										<h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
										<p class="wptb-tab-content--description"> DirectoryBaba.com Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
										<div class="wptb-item--button"> 
							...
							<div class="tab-pane fade" id="tab-four" role="tabpanel">
								<div class="wptb-tab-content">
									<div class="wptb-tab-content--holder">
										<div class="wptb-tab-content--icon">
											<img src="assets/img/clients/hc-logo4.png" alt="icon">
										</div>
										<h3 class="wptb-tab-content--title">Committed to provide you best services</h3>
										<p class="wptb-tab-content--description"> DirectoryBaba.com Visa Consultancy travel created to provide uniquely designed premium services in the world of</p>
										<div class="wptb-item--button"> 
					...
					<div class="wptb-item--right">
						<ul class="wptb-item--holder" id="pills-tab" role="tablist">
							<li class="wptb-item--title">
								<a class="wptb-item--link active" href="#tab-one" data-bs-toggle="tab" role="tab"><i class="bi bi-arrow-right"></i> British Council</a>
							</li>
							<li class="wptb-item--title">
								<a class="wptb-item--link" href="#tab-two" data-bs-toggle="tab" role="tab"><i class="bi bi-arrow-right"></i> USA Embassy</a>
							</li>
							<li class="wptb-item--title">
								<a class="wptb-item--link" href="#tab-three" data-bs-toggle="tab" role="tab"><i class="bi bi-arrow-right"></i> Australian Embassy</a>
							</li>
							<li class="wptb-item--title">
								<a class="wptb-item--link" href="#tab-four" data-bs-toggle="tab" role="tab"><i class="bi bi-arrow-right"></i> UK Embassy</a>
							</li>
						</ul>
					</div>
		...
		<div class="wptb-image-single position-absolute end-0 top-0 bottom-0 wow skewIn">
			<div class="wptb-item--inner">
				<div class="wptb-item--image">
	...
	<!-- Clients Logo -->
	<div class="wptb-partners-one bg-gradient-one">    
		<div class="container">    
		...
		<div class="container">
			<div class="wptb-heading">
				<div class="row">
					...
					<div class="col-md-6">
						<p class="wptb-item--description">DirectoryBaba.com Visa Consultancy was created to provide uniquely des
					...
					<div class="swiper-slide">
						<div class="wptb-testimonial1">
							<div class="wptb-item--inner">
								...
								<div class="wptb-item--holder">
									<p class="wptb-item--description"> “I am extremely grateful to DirectoryBaba.com Visa Consultancy for making my dream true. The helped me process my visa for Canada. It has accepted in record time. DirectoryBaba.com are amazing so I Highly recommend them.”</p>
			...
			<div class="row">
						...
						<div class="wptb-item--inner">
							...
							<div class="wptb-item--holder">
								<div class="wptb-item--meta">
									...
									<div class="wptb-item-comment"><a href="#comments" class="bg-gradient-one">0</a></div>
								</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="wptb-blog-grid1 style2 wow fadeInLeft">
						<div class="wptb-item--inner">
							<div class="wptb-item--image">
								<a href="blog-details.html" class="wptb-item-link"><img src="assets/img/blog/6.jpg" alt="img"></a>
							</div>
							<div class="wptb-item--holder">
								<div class="wptb-item--meta">
									<div class="wptb-item--date">October 19, 2023</div>
				...
				<div class="col-md-4 col-sm-6">
					<div class="wptb-blog-grid1 style2 wow fadeInLeft">
						<div class="wptb-item--inner">
							<div class="wptb-item--image">
								<a href="blog-details.html" class="wptb-item-link"><img src="assets/img/blog/7.jpg" alt="img"></a>
							</div>
							<div class="wptb-item--holder">
								<div class="wptb-item--meta">
									<div class="wptb-item--date">October 19, 2023</div>
