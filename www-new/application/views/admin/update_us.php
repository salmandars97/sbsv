      <?php foreach ($us_detail as $key => $value) { ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Update United State Page</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url().'US/updated_us' ?>" enctype="multipart/form-data" >
