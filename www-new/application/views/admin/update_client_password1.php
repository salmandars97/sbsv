					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="form-horizontal form-label-left" >
								<?php $attributes = array('id' => 'Main/update_client_password1','name' => 'Main/update_client_password1' ); ?>
				 
								<?php echo form_open_multipart(''.base_url().'Main/updated_client_password1',$attributes);?>
