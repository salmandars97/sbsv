				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<div class="col-md-6">
									<h2>Aipp Assessments<small></small></h2>
								</div>
								<div class="clearfix"></div>
							</div>
							<div class="clearfix"></div>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url().'Leads/assign_aipp_assessment?aid=' . $value->id . '&atype=aipp&page=' . $page; ?>" class="btn btn-primary btn-sm">
												Assign
											</a>
										</td>
									</tr>
