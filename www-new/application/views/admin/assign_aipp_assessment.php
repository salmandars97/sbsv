...
<div class="right_col" role="main">
	<div class="">
		<div class="page-title">
			...
			<a href="<?php echo base_url().'Leads/pending_aipp_leads' ?>"><input type="submit" class="btn btn-info btn-md" style="float:right;" value="Back"></a>
		</div>
...
function assign(){
	if($("#user").val() != '0')
	{
		...
		var c = "submit_aipp_assessment?aid=" + url.searchParams.get("aid");
