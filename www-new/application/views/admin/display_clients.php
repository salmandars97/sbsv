        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <div class="col-md-10">
                            <h2>Display Clients<small></small></h2><br>
                            <h2 class="text-danger">Please Disable adblocker. before downloading files.</h2>
                        </div>

                        <div class="col-md-2">
                            <!-- Welcome Admin! -->
                            <form method="post" action="<?= base_url().'Main/add_client' ?>">
                ...
                <div class="x_content">
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#success<?php echo $value->id; ?>" data-toggle="modal"> View
                                            Document</a>
                                        <form action="<?php echo base_url().'Main/display_document?id=' . $value->id ?>"
                                            method="post">
                                    ...
                                    <td>
                                        <form action="<?php echo base_url().'Main/updateState' ?>" method="post">
                                        ...
                                        <form action="<?php echo base_url().'Main/delete_client' ?>" method="post">
                                            <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                                            <input type="submit"
                                                onclick="return confirm('Are you sure you want to delete?');"
                                                class="btn btn-block btn-danger btn-sm" value="Delete" />
                                        </form>
                                        <form action="<?php echo base_url().'Main/update_client' ?>" method="get">
                                            <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                                            <input type="submit" class="btn btn-block btn-success btn-sm"
                                                value="Edit" />
                                        </form>
                                        <form action="<?php echo base_url().'Main/update_client_password' ?>"
                                            method="get">
                                            <input type="hidden" name="id" value="<?php echo $value->id; ?>">
                                            <input type="submit" class="btn btn-block btn-info btn-sm"
                        ...
                        <?php
                            $randomName = "aa" . rand();
                            ?>
                        <div class="modal fade" id="success<?php echo $value->id; ?>" tabindex="-1" role="dialog"
                            ...
                            foreach ($display_uplo as $key => $value1) {
                                if($value1->c_id == $value->id) {
                                    ?>
                                        <div class="row">
                                            <div class="col-sm-6 h4">
                                                <a target="blank" class="<?= $randomName ?>"
                                                    href="<?php echo base_url().'assets/upload/files/'?><?= $value1->file_name ?>">
                                                    <?= $value1->file_name ?>
                                                </a>
                                            </div>
                                            <div class="col-sm-6 text-right h4">
                                                <b>
                                                    <?= date('Y-m-d', strtotime($value1->uploaded_on)) ?>
                                                </b>
                                            </div>
                                        </div>
                                        <form action="<?php echo base_url().'Main/delete_docu' ?>" method="post">
                                            <input type="hidden" name="id" value="<?php echo $value1->id; ?>">
                                            <input class="btn-sm btn-danger btn-block" type="submit"
                                                onclick="return confirm('Are you sure you want to delete?');"
                                                value="Delete" />
                                        </form>
                                    ...
                                    <div class="modal-footer">
                                        <form target="_blank" action="<?= base_url().'Main/download_client_docs'?>"
                                            method="post">
                                            ...
                                            <!-- <input type="submit" name="ZIP" class="btn btn-primary pull-right"
                                                value="Submit Zip" /> -->
                                        </form>
                                    </div>
                                </div><!-- /.modal-content -->
