			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<div class="col-md-10">
								<h2><?php if($_SESSION['clients_type'] == 'aipp') { echo 'AIPP'; } else{ echo "Immigration"; } ?> Clients<small></small></h2><br>
                            <h2 class="text-danger">Please Disable adblocker. before downloading files.</h2>
							</div>

							<div class="col-md-2">
								<!-- Welcome Admin! -->
								<form method="post" action="<?= base_url().'Crmauth/add_client' ?>">
							...
							<tbody>
								...
								<tr>
									...
									<td> 
										...
										<form action="<?php echo base_url().'Crmauth/delete_client' ?>" method="post">
											<input type="hidden" name="id" value="<?php echo $value->id; ?>">
										...
										<form action="<?php echo base_url().'Crmauth/update_client' ?>" method="get">
											<input type="hidden" name="id" value="<?php echo $value->id; ?>">
											<input type="submit" class="btn btn-block btn-success btn-sm" value="Edit" />
										</form>						  
										<form action="<?php echo base_url().'Crmauth/update_client_password' ?>" method="get">
											<input type="hidden" name="id" value="<?php echo $value->id; ?>">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<form action="<?php echo base_url().'Crmauth/delete_docu' ?>" method="post">
