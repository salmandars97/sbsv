  ...
  $.fn.googlePlaces = function(options) {
    ...
    var renderReviews = function(reviews) {
      ...
      for (var i = rowCount; i >= 0; i--) {
        ...
        //html = html + "<div class="+ style +"><div class='review-header'>"+ picture +"<div class='review-usergrade'><div class='review-meta'><span class='review-author'>" + name + "</span><span class='review-sep'></span>" + "</div>"+ stars + "<span class='review-date'>"+date+"</span>" + "</div></div><p class='review-text'>" + review.text + "</p></div>";
        html = html +"<div class='single-review item'>"
		+"<div class='title justify-content-start d-flex'><h4>"
		+ name + 
		"</h4>"		
		+ stars + 
		"<hr><b>"
      ...
      targetDivJquery.append("<div class='active-review-carusel' >" + html + "</div>");
	   $(".active-review-carusel").owlCarousel({items:2,margin:30,autoplay:!0,loop:!0,dots:!0,responsive:{0:{items:1},480:{items:1},768:{items:2}}});
    };
